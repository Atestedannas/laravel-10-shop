...
{
    /**
     * 閸忓懎鈧棿鑵戣箛鍐€夐棃銏℃殶閹?     * 返回: { balance, plans }
     */
    ...
    public function submit(Request $request)
    {
        ...
        if (!$planId) {
            return api_response(null, '閸忓懎鈧吋鏌熷鍦汥不能为空', 500);
        }

        // 閺屻儲澹橀崠褰掑帳閻ㄥ嫬鍘栭崐鍏兼煙濡?        $plans = [
        ...
        if (!isset($plans[$planId])) {
            return api_response(null, '閺冪姵鏅ラ惃鍕帠閸婂吋鏌熷?, 400);
        }
    ...
    public function tradeQuery(Request $request)
    {
        ...
        if (!$outTradeNo) {
            return api_response(null, '娴溿倖妲楅崡鏇炲娇不能为空', 500);
        }
    ...
    /**
     * 閸忓懎鈧壈顔囪ぐ鏇炲灙鐞涱煉绱欓崚鍡涖€夐敍?     * 返回:recharge 列表     */
